package dev.viegas.examgenerator.security.service;

import dev.viegas.examgenerator.models.ApplicationUser;
import dev.viegas.examgenerator.repositories.ApplicationUserRepository;
...
public class CustomUserDetailsService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ApplicationUser applicationUser = loadApplicationUserByUsersame(username);
        return new CustomUserDetails(applicationUser);
    }

    public ApplicationUser loadApplicationUserByUsersame(String username) {
